...
private val LightColorPalette = FashionColors(
    brand = Shadow5,
...
private val DarkColorPalette = FashionColors(
    brand = Shadow1,
...
@Composable
fun FashionTheme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
    ...
    ProvideFashionColors(colors = colors) {
        MaterialTheme(
...
object FashionTheme {
    val colors: FashionColors
        @Composable
        get() = LocalFashionColors.current
}

/**
 * Fashion custom Color Palette
 */
@Stable
class FashionColors(
    ...
    fun update(other: FashionColors) {
    ...
    fun copy(): FashionColors = FashionColors(
...
fun ProvideFashionColors(
    ...
    CompositionLocalProvider(LocalFashionColors provides colorPalette, content = content)
}

private val LocalFashionColors = staticCompositionLocalOf<FashionColors> {
    error("No FashionColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [FashionTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
